...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMover_Statics::NewProp_MoveOffset = { "MoveOffset", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMover, MoveOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMover_Statics::NewProp_MoveOffset_MetaData), Z_Construct_UClass_UMover_Statics::NewProp_MoveOffset_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMover_Statics::NewProp_MoveTime = { "MoveTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UMover, MoveTime), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UMover_Statics::NewProp_MoveTime_MetaData), Z_Construct_UClass_UMover_Statics::NewProp_MoveTime_MetaData) };
	...
	UMover::~UMover() {}
	struct Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_Mover_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_Mover_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMover, UMover::StaticClass, TEXT("UMover"), &Z_Registration_Info_UClass_UMover, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMover), 1668033602U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_Mover_h_746221754(TEXT("/Script/CryptRaider"),
		Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_Mover_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_Mover_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
