...
// End Cross Module References
	DEFINE_FUNCTION(UTriggerComponent::execSetMyMover)
	{
		P_GET_OBJECT(UMover,Z_Param_Mover);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SetMyMover(Z_Param_Mover);
		P_NATIVE_END;
	}
	void UTriggerComponent::StaticRegisterNativesUTriggerComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "SetMyMover", &UTriggerComponent::execSetMyMover },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics
	{
		struct TriggerComponent_eventSetMyMover_Parms
		{
			UMover* Mover;
		};
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::NewProp_Mover_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::NewProp_Mover = { "Mover", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(TriggerComponent_eventSetMyMover_Parms, Mover), Z_Construct_UClass_UMover_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::NewProp_Mover_MetaData), Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::NewProp_Mover_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::NewProp_Mover,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "TriggerComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UTriggerComponent, nullptr, "SetMyMover", nullptr, nullptr, Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::PropPointers), sizeof(Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::TriggerComponent_eventSetMyMover_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::Function_MetaDataParams), Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::TriggerComponent_eventSetMyMover_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UTriggerComponent_SetMyMover()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UTriggerComponent_SetMyMover_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTriggerComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTriggerComponent_SetMyMover, "SetMyMover" }, // 3732212123
	};
	...
	struct Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_TriggerComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_TriggerComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTriggerComponent, UTriggerComponent::StaticClass, TEXT("UTriggerComponent"), &Z_Registration_Info_UClass_UTriggerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTriggerComponent), 2363534185U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_TriggerComponent_h_2314177179(TEXT("/Script/CryptRaider"),
		Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_TriggerComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProjectsUE_CryptRaider_Source_CryptRaider_TriggerComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
